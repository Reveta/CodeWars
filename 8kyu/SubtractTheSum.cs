...
namespace CodeWars._8kyu {
	/**
		 * https://www.codewars.com/kata/56c5847f27be2c3db20009c3/train/csharp
	...
	public class SubtractTheSum {
		...
		// 	string res = SubtractTheSum.SubtractSum(10000);
		...
		public static string SubtractSum(int number) {
			...
			if (GetFruits().Keys.Contains(newNum)) {
				return GetFruits()[newNum];
			}

			return SubtractSum(newNum);
		}

		private static Dictionary<int, string> GetFruits() {
			while (true) {
				if (resources != null) {
					return resources;
				}
